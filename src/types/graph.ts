...
export interface TypedWorkflowGraph<
  State extends GraphState = "unvalidated",
> extends WorkflowGraph {
...
export interface GraphValidationState {
  ...
  readonly inputSatisfaction: ReadonlyMap<
    NodeId,
    ReadonlyArray<InputSatisfaction>
  >;
...
export type TopologicalSort =
  ...
  | {
      ...
      readonly problematicNodes: ReadonlyArray<NodeId>;
    };
...
export interface GraphDiff {
  ...
  readonly modifiedNodes: ReadonlyArray<{
    readonly old: WorkflowNode;
    readonly new: WorkflowNode;
  }>;
...
export type GraphValidationError =
  ...
  | {
      readonly type: "unsatisfied-input";
      readonly nodeId: NodeId;
      readonly portId: string;
    }
  | {
      readonly type: "invalid-connection";
  ...
  | {
      readonly type: "missing-node";
      readonly nodeId: NodeId;
      readonly referencedBy: EdgeId;
    };
